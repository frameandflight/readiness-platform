...
export const metadata: Metadata = {
  title: 'Frame & Flight — Product Lifecycle Maturity & Gap Analysis',
  description: 'Assess your organization\'s PLM process maturity across nine key capability areas.',
};
